...
- (void)setup {
    ...
    [NSLayoutConstraint activateConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-5-[_leftButton(w)]" options:0 metrics:@{@"w":@(leftImage.size.width)} views:NSDictionaryOfVariableBindings(_leftButton)]];
    ...
    [NSLayoutConstraint activateConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:[_plusButton(w)]-5-|" options:0 metrics:@{@"w":@(plusImage.size.width)} views:NSDictionaryOfVariableBindings(_plusButton)]];
    ...
    [NSLayoutConstraint activateConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:[_emojiButton(w)]-5-[_plusButton]" options:0 metrics:@{@"w":@(emojiImage.size.width)} views:NSDictionaryOfVariableBindings(_emojiButton,_plusButton)]];
...
- (void)centerButtonTouchUpInside:(UIButton *)sender
{
    ...
    {
        [self.audioPressShortView showAndHideWithDelay:0.5f];
    }else{
...
- (YDAudioPressShortView *)audioPressShortView
{
    ...
    {
        _audioPressShortView = [YDAudioPressShortView audioPressShortView];
    }
