...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if(self)
    {
        ...
        [label sw_addConstraintsWithFormat:@"V:[label(>=14)]-10-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(label)];
...
{
    YDAudioPressShortView *view = [[self alloc] initWithFrame:CGRectMake(0, 0, 150, 150)];
    return view;
}

- (void)showAndHideWithDelay:(NSTimeInterval)delay
{
    MBProgressHUD *hud = [[UIApplication sharedApplication].keyWindow showHUDWithCustomView:self];
